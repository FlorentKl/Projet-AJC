...
@EnableWebMvc
@Import(AppConfig.class) // Permet de charger la classe AppConfig du projet JpaSpring, au lieu de passer
                         // par le listener et le fichier xml
